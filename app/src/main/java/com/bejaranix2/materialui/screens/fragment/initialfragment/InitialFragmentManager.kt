...
class InitialFragmentManager : BaseViewManager {
    ...
    private fun viewConfiguration() {
        ...
        mFragmentInitialBinding.manager = this
    }
    ...
    fun nextPage(v: View){
        NavHostFragment.findNavController(mFragment).navigate(InitialFragmentDirections.actionInitialFragmentToNextFragment())
    }
